...
import EmployeeRelevingTable from 'src/components/table-data/EmployeeRelevingTable'

const RelevingEmployeeDetails = () => {
  return (
    <>
      <CRow>
        <CCol xs={12}>
          <CCard className="mb-4">
            <CCardHeader className="text-dark">
              <h5 className={styles.empSubHeader}>Search Releving Employee</h5>
            </CCardHeader>
            <CCardBody>
      ...
      <EmployeeRelevingTable />
    </>
  )
}

export default RelevingEmployeeDetails
